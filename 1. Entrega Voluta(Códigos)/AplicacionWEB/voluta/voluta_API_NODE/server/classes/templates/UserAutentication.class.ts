import { urlDominio, urlEmails } from "../../config/config";


// Plantillas de autenticacion para  email

export default class TemplatesAutenticationEmail {
								...
								<tr>
									<td>
										<div style="padding:0px 40px;font-size:12px">
											...
											<div>&nbsp;</div>
											<div style="text-align:left">Confirmar mi dirección de Email <a href="${ urlEmails.accountValidateEmail }${ this.token }" target="_blank" data-saferedirecturl="">aquí</a>.</div>
											<div style="text-align:left">&nbsp;</div>
